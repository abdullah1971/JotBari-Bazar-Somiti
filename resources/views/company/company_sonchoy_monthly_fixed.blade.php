...
@section('sidebar_navigation')
	...
	<div id="sidebar_links" style="font-size: 17px;">
		...
		<div class="list-group">
		  ...
		  <a href="{{ route('company.fixed_monthly_sonchoy') }}" class="list-group-item active">ফিক্স মাসিক সঞ্চয় </a>
	  ...
	  <table class="table table-hover table-striped">
	  	...
	  	<thead>
	  	      <tr>
	  	        ...
	  	        <th style="text-align: center; font-size: 22px;">ফিক্স সঞ্চয় এর পরিমান </th>
	  	      </tr>
	  	</thead>
	  	    <tbody style="text-align: center; font-size: 22px;">
	  	    	...
	  	    	@foreach ($user_account_instance as $single_user_account)
		  	      ...
		  	      <tr>
		  	        ...
		  	        <td>{{ $single_user_account->fixed_sonchoy }}</td>
		  	      </tr>
