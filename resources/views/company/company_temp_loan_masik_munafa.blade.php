...
@section('main_frame_content')
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <form id="" class="form-horizontal form-label-left" method="post" action="{{ route('company.temp_loan_masik_munafa_update') }}">
          ...
          {{ csrf_field() }}
              ...
              <div id="loan_masik_munafa_joma" class="form-group">
              ...
              <div id="loan_masik_jorimana" class="form-group">
              ...
              <div id="money_amount" class="form-group">
                <label for="money_amount_input" class="control-label col-md-3 col-sm-3 col-xs-12">
                  মোট টাকা
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input name="money_amount_input" id="money_amount_input" class="form-control col-md-7 col-xs-12"  type="number" min="0">
                </div>
              </div>
