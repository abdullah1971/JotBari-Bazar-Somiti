...
@section('sidebar_navigation')
	...
	<div id="sidebar_links" style="font-size: 17px;">
		...
		<div class="list-group">
		  ...
		  <a href="{{ route('company.reserve_income') }}" class="list-group-item">আয় </a>
		  <a href="{{ route('company.reserve_spend') }}" class="list-group-item active">ব্যয় </a>
	  	...
	  	<thead>
	  	    ...
	  	    <tbody style="text-align: center; font-size: 22px;">
	  	    	...
	  	    	@foreach ($reserve_instance as $single_reserve_income)
		  	      ...
		  	      <tr>
		  	        <td>{{ $single_reserve_income->subject }}</td>
