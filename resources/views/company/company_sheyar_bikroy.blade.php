...
@section('sidebar_navigation')
	...
	<div id="sidebar_links" style="font-size: 17px;">
		...
		<div class="list-group">
		  ...
		  <a href="{{ route('company.kroy_sheyar') }}" class="list-group-item">ক্রয় </a>
		  <a href="{{ route('company.bikroy_sheyar') }}" class="list-group-item active">হস্তান্তর </a>
...
@section('main_frame_content')
	...
	<div class="table-responsive" style="margin-top: 20px;">
	  <table class="table table-hover table-striped">
	  	...
	  	<thead>
	  	      <tr>
	  	        <th style="text-align: center; font-size: 22px;">যে বিক্রয় করেছে </th>
	  	    ...
	  	    <tbody style="text-align: center; font-size: 22px;">
	  	    	@foreach ($sheyar_info as $single_sheyar)
		  	      ...
		  	      <tr>
		  	        ...
		  	        <td>{{ $single_sheyar->UserBasicInfoBikroy->name ." ( ". $single_sheyar->UserBasicInfoBikroy->membership_no ." )" }}</td>
